...
public class XenograftInterventionsDataWriter : DataWriter<SpecimenModel, InterventionsUploadAudit>
{
    ...
    public XenograftInterventionsDataWriter(IDbContextFactory<DomainDbContext> dbContextFactory) : base(dbContextFactory)
    {
    ...
    protected override void ProcessModel(SpecimenModel model, ref InterventionsUploadAudit audit)
    {
        ...
        var interventions = _interventionRepository.CreateOrUpdate(specimen.Id, ((XenograftModel)model).Interventions);
