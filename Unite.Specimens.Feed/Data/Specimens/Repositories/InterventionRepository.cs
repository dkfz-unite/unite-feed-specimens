...
internal class InterventionRepository
{
    ...
    public IEnumerable<Intervention> CreateOrUpdate(int specimenId, IEnumerable<InterventionModel> models)
    {
    ...
    public IEnumerable<Intervention> CreateMissing(int specimenId, IEnumerable<InterventionModel> models)
    {
    ...
    public IEnumerable<Intervention> UpdateExisting(int specimenId, IEnumerable<InterventionModel> models)
    {
    ...
    public void RemoveRedundant(int specimenId, IEnumerable<InterventionModel> models)
    {
